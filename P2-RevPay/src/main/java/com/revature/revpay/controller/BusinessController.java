...
public class BusinessController {
    ...
    public String createInvoice(Authentication auth,
        ...
        User customer = userService.findByEmailOrPhone(customerEmail);
        if (customer == null) {
            ra.addFlashAttribute("errorMsg", "User not found, please enter valid customer details!");
            return "redirect:/business/invoices/new";
        }
